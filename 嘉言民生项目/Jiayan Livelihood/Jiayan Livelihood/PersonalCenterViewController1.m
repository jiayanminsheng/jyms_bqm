...
#import "PersonalCenterViewController1.h"
#import "UserPrefs.h"
...
@interface PersonalCenterViewController1 ()<UITableViewDataSource,UITableViewDelegate>{
    //用tableview布局的
    NSArray *_imageArr;
...
@implementation PersonalCenterViewController1
