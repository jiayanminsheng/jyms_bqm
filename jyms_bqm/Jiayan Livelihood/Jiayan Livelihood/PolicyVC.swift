...
//-------------------------------------------------------------------------------------------------
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        //标题
        let titleLabel:UILabel=UILabel(frame: CGRectMake(sWidth*0.38,sHeight*0.02,sWidth*0.6,sHeight*0.05));
        ...
        //内容概要
        let sumLabel:UILabel=UILabel(frame: CGRectMake(sWidth*0.37,sHeight*0.06,sWidth*0.6,sHeight*0.08));
        ...
        let dataLabel:UILabel=UILabel(frame:CGRectMake(sWidth*0.37,sHeight*0.13,sWidth*0.15,sHeight*0.02));
        dataLabel.text="2015-10-28"
        if(IS_IPHONE_4_OR_LESS)
        {
            dataLabel.font=UIFont(name: "HelveticaNeue", size: 8);
        }
        else
        {
        ...
        let eyeView:UIImageView=UIImageView(frame: CGRectMake(sWidth*0.8, sHeight*0.13, sWidth*0.04, sHeight*0.016));
        let eyeImage:UIImage=UIImage(named: "eye")!
        eyeView.image=eyeImage;
        
        //点击量数字
        let numView:UILabel=UILabel(frame:CGRectMake(sWidth*0.86, sHeight*0.13, sWidth*0.08, sHeight*0.016))
        numView.text="1000"
        if(IS_IPHONE_4_OR_LESS)
        {
            numView.font=UIFont(name: "HelveticaNeue", size: 8);
        }
        else
        {
